...
<a href="https://www.youtube.com/watch?v=XroVMhYW4ls"><img width="512" height="288" alt="networkdiagramfinal" src="https://github.com/user-attachments/assets/3bc79949-6396-43aa-88e8-02538bdac1e4" /></a>
...
Next, we will install our DHCP server. You will select Add roles and features on the server manager again. Advance to server selection and select your domain controller and advance to Server Roles where you will select DHCP Server and then advance to installation. 
